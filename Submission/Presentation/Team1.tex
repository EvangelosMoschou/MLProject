...
\begin{enumerate}
    ...
    \item \textbf{Final Predictions:} NNLS Stacking (5 seeds)
\end{enumerate}
\end{block}
\end{frame}
...
\begin{itemize}
    \item Per-model masks (Cat: 179, XGB: 180)
    \item Μείωση θορύβου
\end{itemize}
...
\begin{itemize}
    ...
    \item Περιορισμός: max 10000 samples, 500 features (v2.5)
...
\begin{enumerate}
    ...
    \item Δημιουργία ξεχωριστών masks: CatBoost → 179, XGBoost → 180 features
\end{enumerate}
\end{block}
...
\begin{itemize}
    ...
    \item \textbf{TabPFN:} Χρησιμοποιεί raw data (bypasses Razor)
\end{itemize}
\end{exampleblock}
\end{frame}
