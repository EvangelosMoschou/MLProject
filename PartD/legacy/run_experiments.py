...
# Import utils
from experiment_utils import log_to_history, load_data, evaluate_model, HISTORY_FILE

warnings.filterwarnings('ignore')


# --- Model Definitions (from solution_d.py) ---
...
def run_baseline_experiment(X, y, cv_folds=5):
    ...
    print(f"--- Running Baseline Experiment (RF) ---")
    ...
    log_to_history(
        ...
        params={'model_params': 'StackingEnsemble(SVM+RF+XGB+MLP)', 'cv_folds': cv_folds},
